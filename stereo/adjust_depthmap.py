...
left_image = cv2.imread('rect_left.png', cv2.IMREAD_GRAYSCALE)
right_image = cv2.imread('rect_right.png', cv2.IMREAD_GRAYSCALE)

rectified_pair = (left_image, right_image )
